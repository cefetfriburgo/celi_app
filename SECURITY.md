...
To test trhe code during the design phase, clone the repository and use static analysis tools. Here are some suggestions:
...
You can use a virtual machine with the pre-installed software to run your security tests.
...
- **GitHub Security Advisory:** [https://github.com/cefetfriburgo/celi_app/security/advisories](https://github.com/cefetfriburgo/celi_app/security/advisories)
